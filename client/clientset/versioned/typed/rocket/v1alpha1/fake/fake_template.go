...
var templatesResource = schema.GroupVersionResource{Group: "rocket", Version: "v1alpha1", Resource: "templates"}

var templatesKind = schema.GroupVersionKind{Group: "rocket", Version: "v1alpha1", Kind: "Template"}
