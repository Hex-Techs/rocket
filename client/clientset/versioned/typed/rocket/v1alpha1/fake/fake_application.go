...
var applicationsResource = schema.GroupVersionResource{Group: "rocket", Version: "v1alpha1", Resource: "applications"}

var applicationsKind = schema.GroupVersionKind{Group: "rocket", Version: "v1alpha1", Kind: "Application"}
