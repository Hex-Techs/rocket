...
func newTemplates(c *RocketV1alpha1Client, namespace string) *templates {
	return &templates{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *templates) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Template, err error) {
...
func (c *templates) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.TemplateList, err error) {
...
func (c *templates) Create(ctx context.Context, template *v1alpha1.Template, opts v1.CreateOptions) (result *v1alpha1.Template, err error) {
	result = &v1alpha1.Template{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("templates").
...
func (c *templates) Update(ctx context.Context, template *v1alpha1.Template, opts v1.UpdateOptions) (result *v1alpha1.Template, err error) {
	result = &v1alpha1.Template{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("templates").
...
func (c *templates) UpdateStatus(ctx context.Context, template *v1alpha1.Template, opts v1.UpdateOptions) (result *v1alpha1.Template, err error) {
	result = &v1alpha1.Template{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("templates").
...
func (c *templates) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Template, err error) {
	result = &v1alpha1.Template{}
